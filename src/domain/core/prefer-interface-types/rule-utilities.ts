/** Type definition for function-like nodes carrying parameters and return types. */
...
/** Type definition for nodes that can wrap a single parameter-like child. */
...
/** Type definition for nodes exposing a nested type annotation wrapper. */
...
export type { TypeAnnotationNode, VariableDeclaratorNode };
