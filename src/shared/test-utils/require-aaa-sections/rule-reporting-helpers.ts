...
import type { TestBlockAnalysis } from "../../../domain/testing/aaa";
import type { RequireAaaSectionsMessageId } from "../../../domain/testing/require-aaa-sections/rule.reporting-helpers";

import {
  getMockSectionComments,
  getMockStatements,
  isRequireAaaSectionsMessageId,
} from "../../../domain/testing/require-aaa-sections/rule.reporting-helpers";
...
async function loadRequireAaaSectionsRule(): Promise<Rule.RuleModule> {
  const { requireAaaSectionsRule } =
    await import("../../../domain/testing/require-aaa-sections/rule");
